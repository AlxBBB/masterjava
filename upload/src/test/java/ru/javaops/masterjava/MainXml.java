...
public class MainXml {
    ...
    private static Set<User> parseByJaxb(String projectName, URL payloadUrl) throws Exception {
        JaxbParser parser = JaxbParser.get(ObjectFactory.class);
        parser.setSchema(Schemas.ofClasspath("src/resources/payload.xsd"));
        Payload payload;
    ...
    private static String transform(String projectName, URL payloadUrl) throws Exception {
        URL xsl = Resources.getResource("src/resources/groups.xsl");
